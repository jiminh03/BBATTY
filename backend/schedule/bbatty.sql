...
DROP DATABASE IF EXISTS BBATTY;
CREATE DATABASE BBATTY;
USE BBATTY;

-- KBO 팀 정보 테이블 (경기장 정보 포함)
CREATE TABLE `team` (
...
INSERT INTO `team` (`id`, `name`, `stadium`, `latitude`, `longitude`) VALUES
(1, '한화 이글스', '한화생명 이글스파크', 36.3272, 127.4286),
(2, 'LG 트윈스', '서울종합운동장 야구장', 37.5130, 127.0727),
(3, '롯데 자이언츠', '사직야구장', 35.1940, 129.0614),
(4, 'KT 위즈', '수원KT위즈파크', 37.2983, 127.0095),
(5, '삼성 라이온즈', '대구삼성라이온즈파크', 35.8410, 128.6812),
(6, 'KIA 타이거즈', '광주기아챔피언스필드', 35.1681, 126.8889),
(7, 'SSG 랜더스', '인천SSG랜더스필드', 37.4361, 126.6895),
(8, 'NC 다이노스', '창원NC파크', 35.2221, 128.5836),
(9, '두산 베어스', '서울종합운동장 야구장', 37.5130, 127.0727),
(10, '키움 히어로즈', '고척스카이돔', 37.4982, 126.8679);

-- KBO 경기 정보 테이블 (경기장 정보 제거)
CREATE TABLE `game` (
    `id` BIGINT NOT NULL AUTO_INCREMENT,
