...
const s = StyleSheet.create({
  bar: { flexDirection: 'row', backgroundColor: '#fff', paddingHorizontal: 12, borderBottomWidth: StyleSheet.hairlineWidth, borderColor: '#eee' },
  tab: { flex: 1, alignItems: 'center', paddingVertical: 12 },
  txt: { color: '#888', fontWeight: '700', fontSize: 18 },
  activeTxt: { color: '#111' },
  ind: { height: 3, backgroundColor: '#E85A5A', width: '60%', borderRadius: 2, marginTop: 8 },
});
